...
# SKlearn scikitlearn is for clustering/classification

#Streamlit work
from keras.models import load_model              #is to load the trained model
#keras is for deep learning model create
import streamlit as st                           # to show webapp
